...
const CONFIG = {
  github: {
    username: 'valenzuelajanaa', // Your GitHub org/user name. (This is the only required config)
  },
  /**
  ...
  projects: {
    github: {
      ...
      manual: {
        ...
        projects: ['valenzuelajanaa/Bioinformatics'], // List of repository names to display. example: ['arifszn/my-project1', 'arifszn/my-project2']
      },
    },
    external: {
      header: 'My Projects',
  ...
  resume: {
    fileUrl:
      'https://github.com/valenzuelajanaa/valenzuelajanaa.github.io/blob/main/pdf/AValenzuelaCV.pdf' // Empty fileUrl will hide the `Download Resume` button.
  },
  skills: [
